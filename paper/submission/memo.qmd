...
```{r itcor, fig.align='center', fig.cap="Relationship Between Items' Correlations with Macrointerest and Their Number of Observations", fig.height=3}
library(tidyverse)
library(DCPOtools)
...
```{r dets, fig.align='center', fig.cap="Time Series on Political Interest in Germany", fig.height=3}
