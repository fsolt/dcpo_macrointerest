...
R2 longed to see replication materials.
We, as reviewers, have had similar laments.
We are told by the _BJPS_ editor that making those materials available to reviewers is not presently possible.
In the final version, we will of course provide full replication materials on the Dataverse as well as the link to the repository with the complete revision history on GitHub.
