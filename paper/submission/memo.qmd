...
Because this is a Bayesian analysis, it is straightforward to incorporate the measurement error---as @McElreath2016 [, 425] explains, "All you have to do is state your information about the error\ldots [l]ogic does the rest"---and `brms` makes this particularly easy.
