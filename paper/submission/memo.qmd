...
(We note that the analysis we offer in Figure 5 draws exclusively---with the possible and arguable exception of unemployment---on macro-level variables and so does not run afoul of this stricture.)
...
We added an explicit discussion of our approach at page 11. 
