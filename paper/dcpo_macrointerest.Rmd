...
```{r surveyInfo}
tb_survey <-
  import(here("data-raw", "survey_info_macrointerest.xlsx"), sheet = "combined") |>
  mutate(
...
plot_fullCountry <- ls_plot_fullCountry |> map(fun_plot)
...
```{r cpOECD, fig.cap="Data Avaliability: DCPO vs. ESS", fig.height=5}
library(rvest)
tb_ess <-
