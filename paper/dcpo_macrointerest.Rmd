...
load(here("data", "theta_results.rda")) # theta_summary & internalval & ts
...
The supplementary material for this article can be found at [link tbd].
...
Yue Hu appreciates the funding support from National Natural Science Foundation of China (grant number: 72374116) and Tsinghua University Initiative Scientific Research Program (grant number: 2024THZWJC01).
Frederick Solt thanks the Office of the Provost, University of Iowa, and the Cluster of Excellence Politics of Inequality, University of Konstanz, for supporting this research.
...
load(here("data", "item_results.rda")) # macrointerest_items
load(here("data", "tb_ess.rda")) #cpOECD
```
