...
Macrointerest varies greatly around the world, even across relatively similar countries like the advanced democracies.
...
Appendix \@ref(trajectory) presents these macrointerest data for all available countries.]
...
On the debate on whether macrointerest is invigorated or instead discouraged by bad economic conditions, the evidence from this cross-national analysis falls heavily on the side of the latter.
...
# Comparing Coverage of the DCPO Macrointerest Data and the ESS {#ESScomparison}
After creating the cross-sectional time-series macrointerest, we tested theories of macrointerest formation in the thirty-seven advanced democracies of the OECD. 
Figure \@ref(fig:cpOECD) visualizes the advantages of our DCPO macrointerest data over one of the largest and oft-used dataset for studying political attitudes in the advanced democracies, the European Social Survey (ESS).
The year ranges covered by ESS is marked with the light bars by year, and the additional years the DCPO macrointerest data provide are marked dark.
Not only does the DCPO macrointerest data allow the comparison to extend to the nine OECD members in the Americas, East Asia, and the Antipodes, it also provides continuous time series in Europe that extend well beyond the available ESS data.
...
# Tabular Results of Figure \@ref(fig:resplot)
