...
# Comparison with @PetersonEtAl2022
...
On the left panel, we replicate @PetersonEtAl2022's Figure 6
...
plot_peterson <- ggplot(data = df_peterson2022, aes(x = year, y = mean)) +
  ...
  geom_line() +
  geom_ribbon(aes(ymin = mean - qnorm(0.9) * (sd / sqrt(nrow(df_peterson2022))), 
                  ymax = mean + qnorm(0.9) * (sd / sqrt(nrow(df_peterson2022)))), alpha = .5) +
