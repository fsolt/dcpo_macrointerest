...
The long-term, historical effect as evidenced by differences in mean levels across countries is found to be larger, `r get_coef("gdppc_mean", type = "std_coef")` points, but only its 80% credible interval excludes zero (`r get_coef("federal", type = "ci", width = "0.8")`).
