...
@Peterson2022 [, 203] advances this argument: "when there is information that something has gone wrong or the electorate feels that the government is not trustworthy or is performing poorly, then voters should be more likely to attend to the actions of elected officials," but when "there is evidence of success \ldots voters should not waste their energies focusing on the activities of their representatives."
...
Unemployment has long been argued to not to motivate but rather to depress political interest.
[@Rosenstone1982, 26], for example, argued that "it causes a preoccupation with personal economic well-being, and as a result, the citizen withdraws from such external matters as politics."
...
In each of these circumstances, macrointerest is argued to grow in _good_ times and shrink as the context worsens.
...
_Methods_ @Shor2007 @Fairbrother2014
...
if (!file.exists(here::here("data", "results.rda"))) {
  ...
  doubled_sd <- m1$data %>% 
    select(-`mean * 100`, -mean, -sd, -country, -year, -ends_with("_se")) %>% 
...
coef_data0 %>% 
  ...
  xlab(NULL) +
  ylab(NULL) +
  plot_annotation("Notes: Dots indicate posterior means; whiskers, from thickest to thinnest, describe 80%, 90%, and 95% credible intervals; shading depicts the posterior probability density function.")
```
...
Taken as a whole, though, this evidence indicates that it is good times, not bad, that yield higher macrointerest.
