...
(see the trajectories of all the available countries in DCPO in Appendix \@ref(trajectory) and case selection strategy in Appendix \@ref(whyOecd)).
...
Figure\nobreakspace{}\@ref(fig:model) displays the results (see the numeric results in Appendix\nobreakspace{}\@ref(whyOecd).
