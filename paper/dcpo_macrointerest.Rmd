...
The public's interest in politics has long been argued to be fundamental to democracy, the foundation of the widespread civic engagement needed to hold elected officials accountable to citizen demands [see, e.g., @Almond1963]. 
...
Survey dataset codes correspond to those used in the `DCPOtools` R package [@Solt2019].
